...
| 🟡 Vàng  | Đang xử lý    | Đã thanh toán, đang chờ sản phẩm được mã hóa.                |
...
<Steps>
  ...
  <Step title="Xem thông tin và phí">
    ...
    <img
      src="/images/tac-pham/tacpham-28.png"
      alt="Đăng ký tác phẩm"
      style={{ marginTop: "12px", borderRadius: "8px" }}
    />
  ...
  <Step title="Thanh toán phí mã hóa">
    ...
    - Đơn mã hóa được tạo và thực thi giao dịch blockchain

  </Step>
  <Step title="Mã hóa">
    Hệ thống blockchain nội bộ của DipNET sẽ tự động:
    ...
    - Chờ giao dịch được mine vào block

    Thời gian ước tính: **không quá 5 phút khi bắt đầu giao dịch**.

  </Step>
  <Step title="Nhận thông báo kết quả">
    Sau khi được mã hoá:
    - **Được mã hoá thành công**: Tác phẩm chuyển sang "Đã mã hóa" (thẻ xanh). NFT được tạo với Token ID riêng. Bạn nhận email kèm thông tin Token ID và Transaction Hash.

    Thông tin về hợp đồng thông minh, dữ liệu mã hoá được thể hiện ở trong trang chi tiết sản phẩm.

    <img
      src="/images/tac-pham/tacpham-29.png"
      alt="Đăng ký tác phẩm"
      style={{ marginTop: "12px", borderRadius: "8px" }}
    />
...
<AccordionGroup>
  <Accordion title="Phí mã hóa có được hoàn trả nếu giao dịch thát bại không?">
    Phí mã hóa **sẽ được hoàn lại cho bạn** nếu giao dịch thất bại. Thường sẽ
    mất một ngày để hệ thống xử lý.
  </Accordion>
  <Accordion title="Tôi có thể hủy yêu cầu mã hóa sau khi đã thanh toán không?">
    ...
    kết quả mã hoá của hệ thống DipNET.
  </Accordion>
