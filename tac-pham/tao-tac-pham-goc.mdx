...
/>
  ...
  <Step title="Điền thông tin cơ bản">
    ...
    **Lưu ý**: Hãy khai báo các thông tin sản phẩm một cách phù hợp (không quá dài, phù hợp với thuần phong mỹ tục, ...), để phòng tánh trường hợp hồ sơ đăng ký không được duyệt
...
**Lưu ý**: Bạn chỉ có thể tải lên các file với dung lượng nằm trong mức dung lượng hiện có của tài khoản của mình, chú ý về dung lượng hiện tại ở góc trái dưới màn hình.
  </Step>
