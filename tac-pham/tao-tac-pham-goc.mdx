...
mỹ tục, ...), để phòng tánh trường hợp hồ sơ đăng ký không được duyệt
  ...
  <Step title="Tác phẩm được tạo thành công">
    Hệ thống sẽ chuyển hướng bạn về studio quản lý sản phẩm đã được tạo thành công của bạn

      <img
    src="../images/tac-pham/tacpham-7.png"
    alt="Đăng ký tác phẩm"
    style={{ marginTop: "12px", borderRadius: "8px" }}
  />
