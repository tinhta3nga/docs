...
<Steps>
  <Step title="Truy cập trang tạo tác phẩm">
    Truy cập `dipnet.vn/create` hoặc nhấn nút **"Đăng ký công bố"** trong menu điều hướng.
      <img
    ...
    Bạn cũng có thể sử dụng thanh công cụ điều hướng nhanh để tạo tác phẩm nhanh, tự động điều hướng tới trang tạo tác phẩm sau khi thao tác
  </Step>
