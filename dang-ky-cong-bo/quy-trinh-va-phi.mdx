...
<Steps>
  ...
  <img
    src="/images/tac-pham/tacpham-27.png"
    alt="Đăng ký tác phẩm"
    style={{ marginTop: "12px", borderRadius: "8px" }}
  />
...
<Steps>
  ...
  <Step title="Khắc phục vấn đề">
    Chỉnh sửa thông tin tác phẩm tại theo thông báo của admin để giải quyết vấn đề.
  </Step>
...
<AccordionGroup>
  <Accordion title="Phí đăng ký có được hoàn trả nếu đơn bị từ chối không?">
    ...
    Mà sẽ được giữ lại để hệ thống tiếp tục hỗ trợ cho việc bổ sung, cập nhật hồ sơ.
  </Accordion>
