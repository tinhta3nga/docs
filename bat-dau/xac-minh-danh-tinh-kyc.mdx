...
<Steps>
  <Step title="Truy cập trang xác minh">
    ...
    Sau đó lựa chọn nền tảng để xác thực
  ...
  <Step title="Chọn phương thức xác minh">
    Chọn loại giấy tờ muốn sử dụng: **CCCD** hoặc **CMND** và lựa chọn các thông tin cần thiết.
      <img
      src="../images/kyc/kyc-step4.png"
      alt="Đăng ký với Google"
      style={{ marginTop: "12px", borderRadius: "8px" }}
    />
  </Step>
  ...
  <Step title="Xác thực thành công">
    Sau khi xác thực thành công, bạn sẽ được đánh dấu là **Đã xác thực** trên hệ thống và có thể trải nghiệm các dịch vụ của DipNET
    <img
      src="../images/kyc/kyc-step3.png"
      alt="Đăng ký với Google"
      style={{ marginTop: "12px", borderRadius: "8px" }}
    />
  </Step>
...
<AccordionGroup>
  <Accordion title="KYC bị từ chối, tôi phải làm gì?">
    Kiểm tra lý do bị từ chối trong email thông báo, tiến hành chụp lại ảnh giấy
    tờ rõ nét hơn và nộp lại hồ sơ. Các lý do từ chối thường gặp: ảnh mờ, thiếu
    mặt sau giấy tờ, hoặc ảnh selfie không khớp với giấy tờ.
  </Accordion>
