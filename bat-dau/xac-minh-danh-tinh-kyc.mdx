...
<Steps>
  ...
  <Step title="Xác thực thành công">
    Sau khi xác thực thành công, bạn có thể thoải mái trải nghiệm các dịch vụ DipNET mang lại 
  </Step>
</Steps>
...
<AccordionGroup>
  <Accordion title="KYC bị từ chối, tôi phải làm gì?">
    Kiểm tra lý do bị từ chối trong email thông báo, tiến hành chụp lại ảnh giấy tờ rõ nét
